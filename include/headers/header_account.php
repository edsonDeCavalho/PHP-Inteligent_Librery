				...
				<li>
					<div class="input-group">
						<form action="../research/books.php" method="POST">
							<input type="text" name="research" class="form-control" placeholder="I'm looking for a book...">
						...
						<tr>
							<?php
								if(((isset($_SESSION['email'])) AND (!empty($_SESSION['email'])))){
									echo "<td style='float:right'><a href='./deconnexion.php' style='font-size:16px'>LOG OUT</a></td>";
								}
								else{
					...
					if(((isset($_SESSION['email'])) AND (!empty($_SESSION['email'])))){
						echo "<li style='float:right;margin-right:4em'><div class='dropdown show'>
								...
								<div class='dropdown-menu' aria-labelledby='dropdownMenuLink'>
									<a class='dropdown-item' style='color:black' href='./profil.php'>My Profil</a>
									<a class='dropdown-item' style='color:black' href='./favoriteBooks.php'>My favorites history</a>
								</div>
							</div></li>";
					}
				?>
