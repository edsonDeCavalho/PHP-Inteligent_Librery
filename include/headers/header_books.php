<header>
	<nav>
		<ul class="nav-links">
			...
			<li style="margin-top:20px"><a href="../index.php" class="title">Books & cie</a></li>
		</ul>
	</nav>
						...
						<div class="row">
							<div class="col-sm-4">
								<ul class="multi-column-dropdown">
									<li><a href="./books.php?category=Art">Art</a></li>
									<li><a href="./books.php?category=Biography">Biography</a></li>
									<li><a href="./books.php?category=Business">Business</a></li>
									<li><a href="./books.php?category=Computers">Computers</a></li>
									<li><a href="./books.php?category=Cooking">Cooking</a></li>
									<li><a href="./books.php?category=Fiction">Fiction</a></li>
								</ul>
							</div>
							<div class="col-sm-4">
								<ul class="multi-column-dropdown">
									<li><a href="./books.php?category=Health">Health</a></li>
									<li><a href="./books.php?category=History">History</a></li>
									<li><a href="./books.php?category=Humor">Humor</a></li>
									<li><a href="./books.php?category=Mathematics">Mathematics</a></li>
									<li><a href="./books.php?category=Medical">Medical</a></li>		
									<li><a href="./books.php?category=Music">Music</a></li>										
								</ul>
							</div>
							<div class="col-sm-4">
								<ul class="multi-column-dropdown">
									<li><a href="./books.php?category=Nature">Nature</a></li>
									<li><a href="./books.php?category=Philosophy">Philosophy</a></li>
									<li><a href="./books.php?category=Poetry">Poetry</a></li>
									<li><a href="./books.php?category=Psychology">Psychology</a></li>
									<li><a href="./books.php?category=Religion">Religion</a></li>
									<li><a href="./books.php?category=Science">Science</a></li>
								</ul>
							</div>
						</div>
					</ul>
